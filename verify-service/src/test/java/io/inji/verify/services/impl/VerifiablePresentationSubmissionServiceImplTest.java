...
public class VerifiablePresentationSubmissionServiceImplTest {
        ...
        public void setUp() {
                ...
                verifiablePresentationSubmissionService = new VerifiablePresentationSubmissionServiceImpl(
                                vpSubmissionRepository, credentialsVerifier, presentationVerifier,
        ...
        public void testGetVPResult_Success_JSONObject() {
                ...
                List<VCResultWithCredentialStatus> vcResults = List.of(
                                new VCResultWithCredentialStatus("Verified successfully", VerificationStatus.SUCCESS,
                                                new HashMap<>()));
                ...
                VPTokenResultDto resultDto = verifiablePresentationSubmissionService.getVPResult(requestIds,
                                transactionId);
        ...
        public void testGetVPResult_Success_JSONArray() {
                ...
                when(presentationVerifier.verifyAndGetCredentialStatus(anyString(), anyList()))
                                .thenReturn(new PresentationResultWithCredentialStatus(VPVerificationStatus.VALID,
                                                vcResults1))
                                .thenReturn(new PresentationResultWithCredentialStatus(VPVerificationStatus.VALID,
                                                vcResults2));
                when(verifiablePresentationRequestService.getLatestAuthorizationRequestFor(transactionId))
        ...
        public void testGetVPResult_VerificationFailed_InvalidVPStatus() {
                ...
                when(vpSubmissionRepository.findAllById(requestIds)).thenReturn(List.of(vpSubmission));
                when(presentationVerifier.verifyAndGetCredentialStatus(anyString(), anyList())).thenReturn(
                                new PresentationResultWithCredentialStatus(VPVerificationStatus.INVALID,
                                                new ArrayList<>()));
                when(verifiablePresentationRequestService.getLatestAuthorizationRequestFor(transactionId))
                                .thenReturn(new AuthorizationRequestCreateResponse());
        ...
        public void testGetVPResult_MixedVerificationStatuses() {
                ...
                List<VCResultWithCredentialStatus> vcResults = Arrays.asList(
                                new VCResultWithCredentialStatus("Verified successfully", VerificationStatus.SUCCESS,
                                                new HashMap<>()),
                                new VCResultWithCredentialStatus("Verified successfully", VerificationStatus.REVOKED,
                                                new HashMap<>()),
                                new VCResultWithCredentialStatus("Verified successfully", VerificationStatus.EXPIRED,
                                                new HashMap<>()),
                                new VCResultWithCredentialStatus("Verified successfully", VerificationStatus.INVALID,
                                                new HashMap<>()));
        ...
        public void testGetVPResult_AllVerificationStatusTypes() {
                ...
                List<VCResultWithCredentialStatus> successResults = List
                                .of(new VCResultWithCredentialStatus("vc_success", VerificationStatus.SUCCESS,
                                                new HashMap<>()));
                List<VCResultWithCredentialStatus> expiredResults = List
                                .of(new VCResultWithCredentialStatus("vc_expired", VerificationStatus.EXPIRED,
                                                new HashMap<>()));
                List<VCResultWithCredentialStatus> invalidResults = List
        ...
        public void testProcessJsonVpTokens_SimpleVC() {
                ...
                io.mosip.vercred.vcverifier.data.CredentialVerificationSummary mockSummary = mock(
                                io.mosip.vercred.vcverifier.data.CredentialVerificationSummary.class);
                ...
                when(credentialsVerifier.verifyAndGetCredentialStatus(anyString(),
                                eq(io.mosip.vercred.vcverifier.constants.CredentialFormat.LDP_VC), anyList()))
        ...
        public void testProcessSdJwtVpTokens_Success() {
                ...
                when(credentialsVerifier.verifyAndGetCredentialStatus(anyString(),
                                eq(io.mosip.vercred.vcverifier.constants.CredentialFormat.VC_SD_JWT), anyList()))
                                .thenReturn(mockSummary);
                when(verifiablePresentationRequestService.getLatestAuthorizationRequestFor(transactionId))
                                .thenReturn(new AuthorizationRequestCreateResponse());
        ...
        public void testExtractTokens_MixedArray() {
                ...
                String header = Base64.getUrlEncoder().withoutPadding()
                                .encodeToString("{\"typ\":\"vc+sd-jwt\"}".getBytes());
        ...
        public void testExtractTokens_InvalidBase64() {
                ...
                assertThrows(InvalidVpTokenException.class,
                                () -> verifiablePresentationSubmissionService.extractTokens(arrayToken));
        }
        ...
        public void testGetVPResult_V2_success() {
                ...
                PresentationVerificationResultV2 presentationVerificationResult = mock(
                                PresentationVerificationResultV2.class);
                ...
                VCResultV2 vcResult = new VCResultV2(
                ...
                assertEquals("{\"type\":[\"VerifiableCredential\"], \"credentialSubject\": {\"name\":\"John Doe\"}}",
                                credentialResults.getFirst().getVerifiableCredential().toString());
        ...
        @Test
        public void testGetVPResult_RaceCondition_Ordering() {
                // req2 is LATER than req1. We want the result for req2.
                List<String> requestIds = List.of("req2", "req1");
                String transactionId = "tx123";

                // Submission 1 (linked to req1 - OLDER) - uses Ed25519Signature2018
                VPSubmission submission1 = new VPSubmission("req1",
                                "{\"type\":[\"VerifiablePresentation\"],\"proof\":{\"type\":\"Ed25519Signature2018\"},\"verifiableCredential\":[{\"type\":[\"VerifiablePresentation\"]}]}",
                                new PresentationSubmissionDto("id1", "dId1",
                                                List.of(new DescriptorMapDto("id", "format", "path",
                                                                new PathNestedDto("format", "path")))),
                                null, null);

                // Submission 2 (linked to req2 - NEWER) - uses Ed25519Signature2019 (Distinct!)
                VPSubmission submission2 = new VPSubmission("req2",
                                "{\"type\":[\"VerifiablePresentation\"],\"proof\":{\"type\":\"Ed25519Signature2019\"},\"verifiableCredential\":[{\"type\":[\"VerifiablePresentation\"]}]}",
                                new PresentationSubmissionDto("id2", "dId2",
                                                List.of(new DescriptorMapDto("id", "format", "path",
                                                                new PathNestedDto("format", "path")))),
                                null, null);

                // Mock repository returning them in WRONG order (submission1 first)
                when(vpSubmissionRepository.findAllById(requestIds)).thenReturn(List.of(submission1, submission2));

                List<VCResultWithCredentialStatus> vcResults1 = List.of(new VCResultWithCredentialStatus("result1",
                                VerificationStatus.SUCCESS, new HashMap<>()));
                List<VCResultWithCredentialStatus> vcResults2 = List.of(new VCResultWithCredentialStatus("result2",
                                VerificationStatus.SUCCESS, new HashMap<>()));

                // Use thenAnswer to dynamically return result based on input content
                when(presentationVerifier.verifyAndGetCredentialStatus(anyString(), anyList()))
                                .thenAnswer(invocation -> {
                                        String token = invocation.getArgument(0);
                                        if (token.contains("Ed25519Signature2019")) {
                                                return new PresentationResultWithCredentialStatus(
                                                                VPVerificationStatus.VALID, vcResults2);
                                        }
                                        return new PresentationResultWithCredentialStatus(VPVerificationStatus.VALID,
                                                        vcResults1);
                                });
                ...
                assertNotNull(resultDto);
                assertEquals(1, resultDto.getVcResults().size());
                // Expect result2 (corresponding to submission2/req2)
                assertEquals("result2", resultDto.getVcResults().get(0).getVc());
        }
        ...
        public void testGetVPResult_V2_unsignedPresentation() {
                ...
                VPSubmission vpSubmission = new VPSubmission("req123", vpToken,
                                new PresentationSubmissionDto("id", "dId",
                                                List.of(new DescriptorMapDto("id", "format", "path",
                                                                new PathNestedDto("format", "path")))),
                                null, null);
                AuthorizationRequestResponseDto authDetails = new AuthorizationRequestResponseDto("test-client-id",
                                "https://example.com/presentation-definition",
                                new VPDefinitionResponseDto("", List.of(), "", "", null, null), "test-nonce",
                                "https://example.com/redirect", true);
                AuthorizationRequestCreateResponse authResponse = new AuthorizationRequestCreateResponse("req123",
                                transactionId, authDetails, System.currentTimeMillis() + 10000);
                ...
                vcResultDto
                                .setSchemaAndSignatureCheck(
                                                new io.inji.verify.dto.verification.SchemaAndSignatureCheckDto(true,
                                                                null));
        ...
        void testGetVPResult_vpSubmissionWalletErrorV2() {
                ...
                assertThrows(VPSubmissionWalletError.class, () -> verifiablePresentationSubmissionService
                                .getVPResultV2(verificationRequestDto, requestIds, transactionId));
        }
        ...
        void testGetVPResult_V2_tokenMatchingFailed() {
                ...
                assertThrows(io.inji.verify.exception.TokenMatchingFailedException.class,
                                () -> verifiablePresentationSubmissionService.getVPResultV2(verificationRequestDto,
                                                requestIds,
                                                transactionId));
        }
        ...
        void testGetVPResult_vpWithoutProofV2() {
                ...
                assertThrows(VPWithoutProofException.class, () -> verifiablePresentationSubmissionService
                                .getVPResultV2(verificationRequestDto, requestIds, transactionId));
        }
        ...
        void testGetVPResult_vpSubmissionNotFoundV2() {
                ...
                assertThrows(VPSubmissionNotFoundException.class, () -> verifiablePresentationSubmissionService
                                .getVPResultV2(verificationRequestDto, requestIds, transactionId));
        }
}
