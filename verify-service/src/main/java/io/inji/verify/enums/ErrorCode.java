...
public enum ErrorCode {
    ...
    BOTH_SCOPE_AND_DCQL_CANNOT_BE_NULL("BOTH_SCOPE_AND_DCQL_CANNOT_BE_NULL","Both scope and DCQL query cannot be empty."),
    NO_DCQL_QUERY_FOR_SCOPE("NO_DCQL_QUERY_FOR_SCOPE","No DCQL query found for the given scope."),
